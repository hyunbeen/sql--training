...
SELECT plan_table_output
  FROM table( DBMS_XPLAN.display(NULL, 'ex_plan4', 'BASIC') );
--   FROM table( DBMS_XPLAN.display(NULL, 'ex_plan4', 'TYPICAL') );
--   FROM table( DBMS_XPLAN.display(NULL, 'ex_plan4', 'ALL') );
--   FROM table( DBMS_XPLAN.display(NULL, 'ex_plan4', 'OUTLINE') );
--   FROM table( DBMS_XPLAN.display(NULL, 'ex_plan4', 'ADVANCED') );