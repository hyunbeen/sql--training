...
SELECT last_name||salary, concat(last_name, salary)
FROM employees;  -- || : Concatenation Operator == concat function
...
-- 주의) Oracle 의 인덱스 번호는 1부터 시작함!!!
-- ------------------------------------------------------
SELECT substr('123456-1234567', 8, 1)
FROM dual;
...
SELECT '900303-1234567', substr('900303-1234567', -7)
FROM dual;
...
FROM dual;     -- 문자열 왼쪽에서 제거

SELECT trim( TRAILING '0' FROM '0001234567000' )
FROM dual;     -- 문자열 오른쪽에서 제거
